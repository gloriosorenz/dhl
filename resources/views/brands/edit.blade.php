        ...
        <div class="offset-lg-2 col-lg-8 offset-lg-2">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Start Form -->
                    <form method="POST" action="{{action('BrandsController@update', $brand->id)}}" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                        <div class="row">
                            <!-- Brand Name -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="equipment_types_id">
                                        <option value="{{$brand->equipment_types->id}}" selected="true">{{$brand->equipment_types->type}}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="logo" name="logo" value="{{$brand->logo}}">
